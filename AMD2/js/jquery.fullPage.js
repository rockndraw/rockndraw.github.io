    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><i class="fa fa-chevron-left fa-4x"></i></div><div class="' + SLIDES_ARROW_NEXT + '"><i class="fa fa-chevron-right fa-4x"></i></div>');
